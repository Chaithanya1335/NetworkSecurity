...
from networksecurity.cloud.s3_syncer import Sync
...
class TrainingPipeline:
    ...
    def start_data_ingestion(self):
        try:
            data_ingestion_config = DataIngestionConfig(trainig_pipeline_config=self.training_pipeline_config)
    ...
    def run_pipeline(self):
        try:
            ...
            #Uncomment if S3Sync is properly configured
