...
class DataIngestion:
    ...
    def export_collection_as_dataframe(self):
        """
        Read Data From MongoDB as Data Frame.
        """
        try:
    ...
    def export_data_to_featue_store(self,dataframe:pd.DataFrame):
        try:
    ...
    def split_data_as_train_test_split(self,dataframe:pd.DataFrame):
        try:
            ...
            logging.info(
                "Exited split_data_as_train_test_split method of DataIngestion Class"
            )
    ...
    def initiate_data_ingestion(self):
        try:
            ...
            dataframe = self.export_data_to_featue_store(dataframe)
